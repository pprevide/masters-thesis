...
\newcommand\myname{Paul Previde }
\newcommand\mytitle{APPLICATIONS OF DATA MINING TO STUDENT PERFORMANCE PREDICTION AND CURRICULUM DESIGN } % The graduate division requires this to be in caps.
\newcommand\mydegree{Master of Science } % change to  Master of Science if applicable
\newcommand\myfield{Computer Science } % e.g., Mathematics
\newcommand\thismonth{May } % graduation month: May / August / December
\newcommand\thisyear{2019 } % e.g., 2014
